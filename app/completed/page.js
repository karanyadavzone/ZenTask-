...
export default function CompletedPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-mint-50 to-green-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-emerald-600 to-green-600 rounded-b-3xl p-6 text-white mb-6">
        <h1 className="text-2xl font-bold mb-2">Completed Tasks</h1>
        <p className="text-white/80">Great job! Here's what you've accomplished</p>
      </div>
        ...
        {tasksLoading ? (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              {searchQuery.trim() ? 'No tasks match your search' : 'No completed tasks yet'}
            </h3>
